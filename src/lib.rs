...
#[cfg(not(feature = "gui"))]
pub fn run_gui() {
    panic!("GUI feature is not enabled");
}

// Move the main function to a separate module
// so it's only included when the gui feature is enabled
#[cfg(feature = "gui")]
pub mod main {
